...
# __3. Modelling Procedure 📊__
## 3.1 Overall Property Damage Cost
...
### 3.1.2 Frequency Expectation Projections
...
### 3.1.5 Simulating Projected Property Damage from Disasters
...
## 3.2 Projection of Economic Costs
...
#### 3.2.1.1 Owner-occupied Property Damage
...
#### 3.2.1.2 Renter/Owner Equipment Damage
...
#### 3.2.1.3 Temporary Housing Costs
...
## 4.1 Short Term with Program Economic Costs vs Without Program
...
## 4.2 Long term with Program Economic Costs vs Without Program  
...
## 4.3 Capital Requirements for Solvency 
...
## 4.4 Contrasting Voluntary vs Emergency Displacement Costs with Program  
...
# __6. Risk and Risk Mitigation Considerations 📛__
...
# __7. Data and Data Limitations 🎚__
